...
- Refer to the two readings (pdf files) in the github repo for through discussion 

- Rather, we will use an original dataset and go through the step-by-step of conducting Exploratory Data Analysis/Visualization, followed by Exploratory Factor Analysis and Confirmatory Factor Analysis. 

- Think of this as a "guide" that you can refer to later, more than a detailed discussion about the math behind FA
